...
namespace Content.Client.Chemistry.UI
{
    ...
    public sealed partial class ReagentDispenserWindow : FancyWindow
    {
        ...
        // Boomer edit: dispense by reagent id, no jug eject.
        ...
        /// <summary>
        /// Boomer edit: update the internal energy buffer readout (bar + units the current charge can dispense).
        /// </summary>
        private void UpdateEnergy(ReagentDispenserBoundUserInterfaceState state)
        {
            EnergyBar.MaxValue = state.MaxEnergy > 0 ? state.MaxEnergy : 1;
            EnergyBar.Value = state.Energy;

            var units = state.EnergyPerUnit > 0 ? (int) (state.Energy / state.EnergyPerUnit) : 0;
            EnergyLabel.Text = Loc.GetString("reagent-dispenser-window-energy-units-text", ("units", units));
        }
